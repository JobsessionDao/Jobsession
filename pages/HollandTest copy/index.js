  ...
  answerClickA: function () {
   ...
   var k3=this.data.listAB[1];
    ...
    if (this.data.index == 60) {
      wx.redirectTo({
        url: '../HollandResult copy/index?xianshixing='+this.data.xianshixing+'&yanjiuxing='+this.data.yanjiuxing+'&yishuxing='+this.data.yishuxing+'&shehuixing='+this.data.shehuixing+'&qiyexing='+this.data.qiyexing+'&changguixing='+this.data.changguixing,
      })
    }
  },
